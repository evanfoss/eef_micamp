...
Netlist(Thaw)
ElementList(Start)
ElementList(Need,"C9","1206","100uF")
...
ElementList(Need,"C8","unknown","10uF")
...
ChangePinName("C8", 2, "-")
ChangePinName("C8", 1, "+")
ElementList(Need,"C3","rcy(2.50mm, pol=bar+sign, dia=6.3 mm, pin_ringdia=1.75mm, pin_drill=0.70mm)","100uF")
