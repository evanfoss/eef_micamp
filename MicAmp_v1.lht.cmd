Netlist(Freeze)
Netlist(Clear)
Netlist(Add,unnamed_net13,R30-2)
Netlist(Add,unnamed_net13,U2-3)
Netlist(Add,unnamed_net13,C30-1)
Netlist(Add,unnamed_net12,R11-2)
Netlist(Add,unnamed_net12,S1-3)
Netlist(Add,unnamed_net11,R13-2)
Netlist(Add,unnamed_net11,S1-2)
Netlist(Add,unnamed_net10,U2-6)
Netlist(Add,unnamed_net10,U2-2)
Netlist(Add,unnamed_net10,R10-1)
...
Netlist(Add,unnamed_net9,R10-2)
Netlist(Add,unnamed_net9,CONN3-1)
...
Netlist(Add,unnamed_net8,U1-2)
Netlist(Add,unnamed_net8,R11-1)
Netlist(Add,unnamed_net8,R13-1)
Netlist(Add,unnamed_net8,R31-1)
Netlist(Add,unnamed_net7,R30-1)
Netlist(Add,unnamed_net7,U1-6)
Netlist(Add,unnamed_net7,R31-2)
Netlist(Add,unnamed_net6,CONN2-4)
Netlist(Add,unnamed_net6,C7-1)
Netlist(Add,unnamed_net6,R24-1)
...
Netlist(Add,unnamed_net5,CONN2-2)
Netlist(Add,unnamed_net5,C5-1)
Netlist(Add,unnamed_net5,C7-2)
Netlist(Add,unnamed_net5,R23-2)
